...
import { Friend, Colleague, SecureFriendContact, FriendPartial, EventPass, ResultArr } from "./myTypes";
...
// output:  { name: 'Ralph Graham', department: 'Engineering', passCode: 211 }
  ...
  function intersection(
    ...
    friends.reduce((res, friend) => {
      ...
      if (colleague) {
        ...
        // creates a ResultArr object, named rd, from both the friend and colleague
        const ra: ResultArr = {
          name: friend.name,
          age: friend.age,
          contact: {
